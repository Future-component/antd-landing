...
storiesOf('Content|Content9', module)
  .add('Web', () => <Content9 dataSource={Content90DataSource} isMobile={false} />)
  .add('H5', () => <Content9 dataSource={Content90DataSource} isMobile={true} />)
