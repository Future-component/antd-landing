...
storiesOf('Teams|Teams1', module)
  .add('Web', () => <Teams1 dataSource={Teams10DataSource} isMobile={false} />)
  .add('H5', () => <Teams1 dataSource={Teams10DataSource} isMobile={true} />)
