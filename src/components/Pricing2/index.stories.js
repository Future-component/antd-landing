...
storiesOf('Pricing|Pricing2', module)
  .add('Web', () => <Pricing2 dataSource={Pricing20DataSource} isMobile={false} />)
  .add('H5', () => <Pricing2 dataSource={Pricing20DataSource} isMobile={true} />)
