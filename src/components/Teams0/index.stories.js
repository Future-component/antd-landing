...
storiesOf('Teams|Teams0', module)
  .add('Web', () => <Teams0 dataSource={Teams00DataSource} isMobile={false} />)
  .add('H5', () => <Teams0 dataSource={Teams00DataSource} isMobile={true} />)
