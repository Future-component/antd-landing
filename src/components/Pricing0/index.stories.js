...
storiesOf('Pricing|Pricing0', module)
  .add('Web', () => <Pricing0 dataSource={Pricing00DataSource} isMobile={false} />)
  .add('H5', () => <Pricing0 dataSource={Pricing00DataSource} isMobile={true} />)
