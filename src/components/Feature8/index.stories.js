...
storiesOf('Feature|Feature8', module)
  .add('Web', () => <Feature8 dataSource={Feature80DataSource} isMobile={false} />)
  .add('H5', () => <Feature8 dataSource={Feature80DataSource} isMobile={true} />)
