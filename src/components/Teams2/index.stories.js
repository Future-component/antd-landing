...
storiesOf('Teams|Teams2', module)
  .add('Web', () => <Teams2 dataSource={Teams20DataSource} isMobile={false} />)
  .add('H5', () => <Teams2 dataSource={Teams20DataSource} isMobile={true} />)
