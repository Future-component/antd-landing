...
storiesOf('Feature|Feature6', module)
  .add('Web', () => <Feature6 dataSource={Feature60DataSource} isMobile={false} />)
  .add('H5', () => <Feature6 dataSource={Feature60DataSource} isMobile={true} />)
