...
import codeImg1 from '@/assets/index/code-1.png'
import codeImg2 from '@/assets/index/code-2.png'
...
export const Footer00DataSource = {
  ...
  copyright: {
    ...
    children: (
      <span>
        Copyright © {year} <a href="https://www..com/" target="_blank">.com</a> （北京）有限公司 京ICP备
      </span>
    ),
  },
};
...
export const Footer30DataSource = {
  wrapper: { className: 'home-page-wrapper footer3-wrapper' },
  OverPack: { className: 'footer3', playScale: 0.2 },
  block: {
    className: 'home-page',
    children: [
      {
        ...
        content: {
          children: (
            <span>
              <Link to="/">首页</Link>
              <Link to="/course">课程介绍</Link>
              <Link to="/teacher">双师团队</Link>
              <Link to="/cooperation">品牌加盟</Link>
              <Link to="/article">学堂动态</Link>
      ...
      },
      {
        ...
        content: {
          children: (
            <span>
              <p>授权合作：400-893-0918</p>
              <p>课程报名：400-606-9595</p>
              <p>联系地址：北京市海淀区上园村3号知行大厦2层</p>
            </span>
          ),
        },
      },
